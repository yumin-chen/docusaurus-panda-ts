...
// const RestartWarning = () => {
//   return ( <   p className = "rounded-lg border shadow px-4 py-2.5 bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200 mb-4" >
//     <div className="flex items-center gap-2" > < WarningIcon className = { `w-6 h-auto flex-shrink-0 text-yellow-400` }
//     /> < div className = { `flex-1 text-sm text-yellow-700 whitespace-normal	` } > To see settings changes reflected on your site, restart the Tina CLI
//     after saving < em > (local development only) < /em>.         </>               </div >
...
const PostCollection = {
  ...
  path: "blog",
  format: "mdx",
  ui: { defaultItem: { date: docusaurusDate(new Date()) } },
  fields: [
    {
      type: "string",
      name: "title",
...
const ExternalLinkTemplate = {
  ...
  ui: {
    itemProps: (item) => {
      return { label: item?.title ? item?.title : item.name };
    },
  },
  fields: [
    {
...
const CategoryFields = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Generated Index", value: "generated" },
    ],
  },
  {
    name: "docLink",
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { type: "image", label: "Source", name: "src" },
      ],
    },
    ...
    { type: "string", label: "URL", name: "url", required: true },
    {
      ...
      fields: [
        ...NavbarItemFields,
        {
          ...
          fields: [
            ...NavbarItemFields,
            { ...NavbarSubitemProps, fields: NavbarItemFields },
          ],
        },
      ],
    },
            ...
            { type: "string", label: "Title", name: "title" },
            {
              ...
              templates: [
                ...
                },
                {
                  ...
                  label: "Blog",
                  ui: {
                    defaultItem: { label: "Blog" },
                    itemProps: (item) => ({ label: item.label }),
                  },
                  fields: [{ type: "string", label: "Label", name: "label" }],
                },
                {
                  name: "external",
                  label: "External",
                  ...
                  fields: [
                    { type: "string", label: "Label", name: "label" },
                    { type: "string", label: "URL", name: "href" },
                  ],
                },
              ],
            },
...
export default defineConfig({
  ...
  media: { tina: { mediaRoot: "img", publicFolder: "static" } },
  schema: {
    collections: [
      DocsCollection,
      PostCollection,
