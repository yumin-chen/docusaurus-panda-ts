...
declare const PlateContent: React__default.ForwardRefExoticComponent<{
    ...
    renderElement?: src.RenderElementFn | undefined;
...
/** @see {@link withReact} */
declare const createReactPlugin: <OP = src.PluginOptions, OV extends _udecode_slate.Value = _udecode_slate.Value, OE extends src.PlateEditor<OV> = src.PlateEditor<OV>>(override?: Partial<src.PlatePlugin<src.NoInfer<OP>, OV, OE>> | undefined, overrideByKey?: src.OverrideByKey<OV, OE>) => src.PlatePlugin<src.NoInfer<OP>, OV, OE>;
 ...
 */
declare const pluginRenderElement: <V extends Value>(editor: PlateEditor<V>, { component: _component, dangerouslyAllowAttributes, key, props, type, }: PlatePlugin<{}, V>) => RenderElement;
 ...
 */
declare const pluginRenderLeaf: <V extends Value>(editor: PlateEditor<V>, { component, dangerouslyAllowAttributes, key, props, type, }: PlatePlugin<{}, V>) => RenderLeaf;
