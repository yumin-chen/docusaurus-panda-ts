...
declare const getPromiseState: <T>(promise: PromiseLike<T>) => PromiseState | undefined;
declare const isPendingPromise: (value: unknown) => value is PromiseLike<unknown>;
declare const cancelPromise: <T>(promise: PromiseLike<T>, nextValue: unknown) => void;
declare const patchPromiseForCancelability: <T>(promise: PromiseLike<T>) => void;
declare const isPromiseLike: (p: unknown) => p is PromiseLike<unknown> & {
    onCancel?: (fn: CancelHandler) => void;
};
...
declare const buildStore: (atomStateMap?: AtomStateMap, mountedMap?: MountedMap, invalidatedAtoms?: InvalidatedAtoms, changedAtoms?: ChangedAtoms, mountCallbacks?: Callbacks, unmountCallbacks?: Callbacks, storeHooks?: StoreHooks, atomRead?: AtomRead, atomWrite?: AtomWrite, atomOnInit?: AtomOnInit, atomOnMount?: AtomOnMount, ensureAtomState?: EnsureAtomState | undefined, flushCallbacks?: FlushCallbacks | undefined, recomputeInvalidatedAtoms?: RecomputeInvalidatedAtoms | undefined, readAtomState?: ReadAtomState | undefined, invalidateDependents?: InvalidateDependents | undefined, writeAtomState?: WriteAtomState | undefined, mountDependencies?: MountDependencies | undefined, mountAtom?: MountAtom | undefined, unmountAtom?: UnmountAtom | undefined) => Store;
...
export declare const INTERNAL_getPromiseState: typeof getPromiseState;
export declare const INTERNAL_isPendingPromise: typeof isPendingPromise;
export declare const INTERNAL_cancelPromise: typeof cancelPromise;
export declare const INTERNAL_patchPromiseForCancelability: typeof patchPromiseForCancelability;
