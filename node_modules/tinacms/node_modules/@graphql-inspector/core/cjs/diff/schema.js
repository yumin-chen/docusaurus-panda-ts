...
function diffSchema(oldSchema, newSchema) {
    ...
    (0, compare_js_1.compareLists)(oldSchema.astNode?.directives || [], newSchema.astNode?.directives || [], {
        onAdded(directive) {
            addChange((0, directive_usage_js_1.directiveUsageAdded)(graphql_1.Kind.SCHEMA_DEFINITION, directive, newSchema));
        },
        onRemoved(directive) {
