...
})(exports.LogLevelKind || (exports.LogLevelKind = {}));
...
class Logger {
    constructor(optionsOrLogLevel = {}) {
        const { logLevel = exports.LogLevelKind.SILENT, color: { info = "white", verbose = "yellow", debug = "magenta" } = {} } = typeof optionsOrLogLevel === "object" ? optionsOrLogLevel : { logLevel: optionsOrLogLevel };
        this.options = {
            logLevel,
            color: {
                info,
     ...
     */
    logInfo(message) {
        if (this.options.logLevel < exports.LogLevelKind.INFO)
            return;
     ...
     */
    logVerbose(message) {
        if (this.options.logLevel < exports.LogLevelKind.VERBOSE)
            return;
     ...
     */
    logDebug(message) {
        if (this.options.logLevel < exports.LogLevelKind.DEBUG)
            return;
 ...
 */
function evaluate({ typeChecker, node, environment: { preset = "NODE", extra = {} } = {}, moduleOverrides = {}, typescript = TSModule__namespace, logLevel = exports.LogLevelKind.SILENT, policy: { deterministic = false, network = false, console = false, maxOps = Infinity, maxOpDuration = Infinity, io = {
    read: true,
    write: false
}, process = {
    exit: false,
