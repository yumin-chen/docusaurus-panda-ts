(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["diff-match-patch-ts"] = {}));
})(this, (function (exports) { 'use strict';

    exports.DiffOp = void 0;
    (function (DiffOp) {
        DiffOp[DiffOp["Delete"] = -1] = "Delete";
        DiffOp[DiffOp["Equal"] = 0] = "Equal";
        DiffOp[DiffOp["Insert"] = 1] = "Insert";
    })(exports.DiffOp || (exports.DiffOp = {}));
        ...
        toString() {
            ...
            for (let x = 0; x < this.diffs.length; x++) {
                switch (this.diffs[x][0]) {
                    case exports.DiffOp.Insert:
                        op = '+';
                        break;
                    case exports.DiffOp.Delete:
                        op = '-';
                        break;
                    case exports.DiffOp.Equal:
                        op = ' ';
                        break;
                }
    ...
    class DiffMatchPatch {
        ...
        diff_main(text1, text2, opt_checklines, opt_deadline) {
            ...
            if (text1 === text2) {
                if (text1) {
                    return [[exports.DiffOp.Equal, text1]];
                }
                return [];
            }
            ...
            if (commonprefix) {
                diffs.unshift([exports.DiffOp.Equal, commonprefix]);
            }
            if (commonsuffix) {
                diffs.push([exports.DiffOp.Equal, commonsuffix]);
            }
        ...
        diff_cleanupSemantic(diffs) {
            ...
            while (pointer < diffs.length) {
                if (diffs[pointer][0] === exports.DiffOp.Equal) {
                    // Equality found.
                    ...
                    if (diffs[pointer][0] === exports.DiffOp.Insert) {
                    ...
                    if (lastequality &&
                        ...
                        diffs.splice(equalities[equalitiesLength - 1], 0, [
                            exports.DiffOp.Delete,
                            lastequality,
                        ]);
                        // Change second copy to insert.
                        diffs[equalities[equalitiesLength - 1] + 1][0] = exports.DiffOp.Insert;
            ...
            pointer = 1;
            while (pointer < diffs.length) {
                if (diffs[pointer - 1][0] === exports.DiffOp.Delete &&
                    diffs[pointer][0] === exports.DiffOp.Insert) {
                    ...
                    if (overlap_length1 >= overlap_length2) {
                        ...
                        if (overlap_length2 >= deletion.length / 2 ||
                            ...
                            diffs[pointer - 1][0] = exports.DiffOp.Insert;
                            diffs[pointer - 1][1] = insertion.substring(0, insertion.length - overlap_length2);
                            diffs[pointer + 1][0] = exports.DiffOp.Delete;
        ...
        diff_cleanupEfficiency(diffs) {
            ...
            while (pointer < diffs.length) {
                if (diffs[pointer][0] === exports.DiffOp.Equal) {
                    ...
                    // An insertion or deletion.
                    if (diffs[pointer][0] === exports.DiffOp.Delete) {
                        post_del = true;
                    }
                    else {
                        post_ins = true;
        ...
        patch_make(a, opt_b, opt_c) {
            ...
            for (let x = 0; x < diffs.length; x++) {
                ...
                if (!patchDiffLength && diff_type !== exports.DiffOp.Equal) {
                ...
                if (diff_type !== exports.DiffOp.Insert) {
                    char_count1 += diff_text.length;
                }
                if (diff_type !== exports.DiffOp.Delete) {
                    ...
                    if (text1 === text2) {
                        ...
                        if (text1.length > this.Match_MaxBits &&
                            ...
                            for (const diff of patches[x].diffs) {
                                if (diff[0] !== exports.DiffOp.Equal) {
                                    index2 = this.diff_xIndex(diffs, index1);
                                }
                                if (diff[0] === exports.DiffOp.Insert) {
                                    // Insertion
                                    text =
                                ...
                                else if (diff[0] === exports.DiffOp.Delete) {
                                    // Deletion
                                    text =
                                        text.substring(0, start_loc + index2) +
                                ...
                                if (diff[0] !== exports.DiffOp.Delete) {
        ...
        patch_fromText(textline) {
            ...
            while (textPointer < text.length) {
                ...
                while (textPointer < text.length) {
                    ...
                    if (sign === '-') {
                        // Deletion.
                        patch.diffs.push([exports.DiffOp.Delete, line]);
                    }
                    else if (sign === '+') {
                        // Insertion.
                        patch.diffs.push([exports.DiffOp.Insert, line]);
                    }
                    else if (sign === ' ') {
                        // Minor equality.
                        patch.diffs.push([exports.DiffOp.Equal, line]);
                    }
                    else if (sign === '@') {
                        // Start of next patch.
                        break;
        ...
        diff_cleanupMerge(diffs) {
            diffs.push([exports.DiffOp.Equal, '']); // Add a dummy entry at the end.
            let pointer = 0;
            let count_delete = 0;
            let count_insert = 0;
            let text_delete = '';
                ...
                switch (diffs[pointer][0]) {
                    ...
                    case exports.DiffOp.Equal:
                        ...
                        if (count_delete + count_insert > 1) {
                            ...
                            if (count_delete === 0) {
                                diffs.splice(pointer - count_insert, count_delete + count_insert, [exports.DiffOp.Insert, text_insert]);
                            }
                            else if (count_insert === 0) {
                                diffs.splice(pointer - count_delete, count_delete + count_insert, [exports.DiffOp.Delete, text_delete]);
                            }
                            else {
                                diffs.splice(pointer - count_delete - count_insert, count_delete + count_insert, [exports.DiffOp.Delete, text_delete], [exports.DiffOp.Insert, text_insert]);
                            }
                            pointer =
                                pointer -
                                    count_delete -
                        ...
                        else if (pointer !== 0 && diffs[pointer - 1][0] === exports.DiffOp.Equal) {
            ...
            while (pointer < diffs.length - 1) {
                if (diffs[pointer - 1][0] === exports.DiffOp.Equal &&
                    diffs[pointer + 1][0] === exports.DiffOp.Equal) {
        ...
        diff_text1(diffs) {
            const text = [];
            for (let x = 0; x < diffs.length; x++) {
                if (diffs[x][0] !== exports.DiffOp.Insert) {
                    text[x] = diffs[x][1];
                }
            }
            return text.join('');
        ...
        diff_text2(diffs) {
            const text = [];
            for (let x = 0; x < diffs.length; x++) {
                if (diffs[x][0] !== exports.DiffOp.Delete) {
                    text[x] = diffs[x][1];
                }
            }
            return text.join('');
        ...
        diff_compute_(text1, text2, checklines, deadline) {
            ...
            if (!text1) {
                ...
                return [[exports.DiffOp.Insert, text2]];
            }
            if (!text2) {
                // Just delete some text (speedup).
                return [[exports.DiffOp.Delete, text1]];
            }
            ...
            if (i !== -1) {
                ...
                diffs = [
                    [exports.DiffOp.Insert, longtext.substring(0, i)],
                    [exports.DiffOp.Equal, shorttext],
                    [exports.DiffOp.Insert, longtext.substring(i + shorttext.length)],
                ];
                // Swap insertions for deletions if diff is reversed.
                if (text1.length > text2.length) {
                    diffs[0][0] = diffs[2][0] = exports.DiffOp.Delete;
                }
                return diffs;
            }
            if (shorttext.length === 1) {
                ...
                return [
                    [exports.DiffOp.Delete, text1],
                    [exports.DiffOp.Insert, text2],
                ];
            }
            ...
            if (hm) {
                ...
                // Merge the results.
                return diffs_a.concat([[exports.DiffOp.Equal, mid_common]], diffs_b);
            }
        ...
        diff_lineMode_(text1, text2, deadline) {
            ...
            diffs.push([exports.DiffOp.Equal, '']);
            let pointer = 0;
            let count_delete = 0;
            let count_insert = 0;
            let text_delete = '';
        ...
        diff_halfMatch_(text1, text2) {
            ...
            const hm1 = this.diff_halfMatchI_(longtext, shorttext, Math.ceil(longtext.length / 4), this);
            // Check again based on the third quarter.
            const hm2 = this.diff_halfMatchI_(longtext, shorttext, Math.ceil(longtext.length / 2), this);
            let hm;
            if (!hm1 && !hm2) {
                return null;
            }
        ...
        diff_xIndex(diffs, loc) {
            ...
            if (diffs.length !== x && diffs[x][0] === exports.DiffOp.Delete) {
                return last_chars2;
            }
        ...
        diff_fromDelta(text1, delta) {
            ...
            for (const token of tokens) {
                ...
                switch (token.charAt(0)) {
                    case '+': {
                        try {
                            diffs[diffsLength++] = [exports.DiffOp.Insert, decodeURI(param)];
                        }
                        catch (ex) {
                            // Malformed URI sequence.
                    ...
                    case '=': {
                        ...
                        if (token.charAt(0) === '=') {
                            diffs[diffsLength++] = [exports.DiffOp.Equal, text];
                        }
                        else {
                            diffs[diffsLength++] = [exports.DiffOp.Delete, text];
                        }
                        break;
                    }
                    default: {
        ...
        patch_addContext_(patch, text) {
            ...
            if (prefix) {
                patch.diffs.unshift([exports.DiffOp.Equal, prefix]);
            }
            // Add the suffix.
            const suffix = text.substring(patch.start2 + patch.length1, patch.start2 + patch.length1 + padding);
            if (suffix) {
                patch.diffs.push([exports.DiffOp.Equal, suffix]);
            }
        ...
        patch_addPadding(patches) {
            ...
            if (diffs.length === 0 || diffs[0][0] !== exports.DiffOp.Equal) {
                // Add nullPadding equality.
                diffs.unshift([exports.DiffOp.Equal, nullPadding]);
            ...
            diffs = patch.diffs;
            if (diffs.length === 0 || diffs[diffs.length - 1][0] !== exports.DiffOp.Equal) {
                // Add nullPadding equality.
                diffs.push([exports.DiffOp.Equal, nullPadding]);
                patch.length1 += paddingLength;
                patch.length2 += paddingLength;
            }
            ...
            for (let x = 0; x < patches.length; x++) {
                ...
                while (bigpatch.diffs.length !== 0) {
                    ...
                    if (precontext !== '') {
                        ...
                        patch.diffs.push([exports.DiffOp.Equal, precontext]);
                    }
                    while (bigpatch.diffs.length !== 0 &&
                        ...
                        if (diff_type === exports.DiffOp.Insert) {
                        ...
                        else if (diff_type === exports.DiffOp.Delete &&
                            patch.diffs.length === 1 &&
                            patch.diffs[0][0] === exports.DiffOp.Equal &&
                            ...
                            patch.length1 += diff_text.length;
                            start1 += diff_text.length;
                            if (diff_type === exports.DiffOp.Equal) {
                                patch.length2 += diff_text.length;
                                start2 += diff_text.length;
                            }
                            else {
                    ...
                    if (postcontext !== '') {
                        ...
                        if (patch.diffs.length !== 0 &&
                            patch.diffs[patch.diffs.length - 1][0] === exports.DiffOp.Equal) {
                            patch.diffs[patch.diffs.length - 1][1] += postcontext;
                        }
                        else {
                            patch.diffs.push([exports.DiffOp.Equal, postcontext]);
                        }
                    }
                    if (!empty) {
...
//# sourceMappingURL=diff-match-patch-ts.umd.js.map
